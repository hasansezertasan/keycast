...
class DisplayWindow:
    ...
    def _setup_window(self) -> None:
        ...
        # self.iconbitmap(bitmap=Path(__file__).parent / "assets" / "icon.ico")  # noqa: ERA001
        # self.iconphoto(1, tk.PhotoImage(file=Path(__file__).parent / "assets" / "icon.png"))  # noqa: ERA001
